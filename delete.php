...
if (isset($_POST['delet'])) {
    ...
    while ($row = mysqli_fetch_assoc($query_run)) {
        ...
        $name = $row['name'];
        $newQuery = "INSERT INTO $set (weight, color, vendor, rws, machine, sensor, quantity, time, delivered, name) VALUES ('$weight', '$color', '$vendor', '$rws', '$machine', '$sensor', '$quantity', '$time', '$delivered', '$name')";
